...
public class Meniu extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ft.replace(R.id.flMain, new Descriere());
        ft.commit();
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        // automatically handle clicks on the Simulare/Up button, so long
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.introduction) {
            ...
            android.support.v4.app.FragmentTransaction ft = getSupportFragmentManager().beginTransaction();
            ft.replace(R.id.flMain, new Simulare());
            ft.commit();

        }else if (id == R.id.info) {

            android.support.v4.app.FragmentTransaction ft = getSupportFragmentManager().beginTransaction();
            ft.replace(R.id.flMain, new Informatii());
            ft.commit();
